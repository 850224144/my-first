#!/usr/bin/env python3
"""
v2.5.8 watchlist + XGB live pools 预览。
只读 final_signal，不写 paper_trader。
XGB live pools 如无缓存，会默认联网拉取一次。
"""
...
def main():
    ...
    report = preview_watchlist_with_xgb_live_v258(
    ...
    print("【v2.5.8 watchlist + XGB live pools 预览】")
