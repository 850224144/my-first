...
def main():
    ...
    parser.add_argument("--persist-tail", action="store_true", help="tail_confirm 写入 trading_state.db")
    parser.add_argument("--no-fetch-xgb", action="store_true")
    args = parser.parse_args()

    result = run_intraday_tail_pipeline_v264(
    ...
    print("【v2.6.4 Intraday Tail Pipeline 完成】")
    print(dumps({
