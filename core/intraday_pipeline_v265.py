...
def run_intraday_tail_pipeline_v265(
    *,
    ...
    tail = run_tail_confirm_from_tail_focus_v265(
        trade_date=trade_date,
        tail_focus_path=tail_focus_path,
    ...
    consistency = {
        "observe_tail_focus_rows": observe.get("tail_focus_rows"),
        "tail_confirm_input_rows": tail.get("input_rows"),
        "is_consistent": observe.get("tail_focus_rows") == tail.get("input_rows"),
        "tail_focus_path": str(tail_focus_path),
    }
